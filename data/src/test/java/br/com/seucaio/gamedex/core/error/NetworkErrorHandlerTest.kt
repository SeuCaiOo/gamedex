...
class NetworkErrorHandlerTest {
    ...
    @Test
    fun `handleNetworkError should return NetworkUnavailableException when network is unavailable`() {
        // Given
        val error = RuntimeException()

        // When
        val result = error.handleNetworkError(isNetworkAvailable = false)
    ...
    @Test
    fun `handleNetworkError should return NoInternetException for UnknownHostException`() {
        // Given
        val error = Exception(UnknownHostException())

        // When
        val result = error.handleNetworkError(isNetworkAvailable = true)
    ...
    @Test
    fun `handleNetworkError should return NoInternetException for SocketException`() {
        // Given
    ...
    @Test
    fun `handleNetworkError should return TimeoutException for SocketTimeoutException`() {
        // Given
    ...
    @Test
    fun `handleNetworkError should return TimeoutException for InterruptedIOException`() {
        // Given
    ...
    @Test
    fun `handleNetworkError should return ServerException for HttpException with code 500`() {
        // Given
    ...
    @Test
    fun `handleNetworkError should return ApiException for HttpException with code 404`() {
        // Given
        val httpException = HttpException(
    ...
    @Test
    fun `handleNetworkError should return ParseException for SerializationException`() {
        // Given
    ...
    @Test
    fun `handleNetworkError should return UnknownException for other exceptions`() {
        // Given
    ...
    @Test
    fun `handleNetworkError should return UnknownException for null cause`() {
        // Given
